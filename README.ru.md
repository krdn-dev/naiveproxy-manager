...
| 🖥️ **Кроссплатформенность** | Работает на Debian, Ubuntu, CentOS, Fedora, AlmaLinux, Rocky Linux |
...
| 🎨 **Кастомная страница-заглушка** | Создание корпоративной страницы с подстановкой вашего домена |
